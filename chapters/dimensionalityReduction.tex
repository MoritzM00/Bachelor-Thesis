...
Die Merkmalsextrahierung ist ein sehr verwandtes Gebiet zur Dimensionsreduktion, da Methoden der
Dimensionsreduktion für die Merkmalsextrahierung eingesetzt werden. Das Ziel hierbei ist es
oftmals, in einem Vorverarbeitungsschritt (Preprocessing) irrelevante Merkmale durch eine
Transformation der Merkmale zu entfernen und dann den eigentlichen Schätzer (Klassifikator oder
Regressor) auf den neuen Merkmalen zu trainieren. Eng damit verbunden ist die Merkmalsauswahl
(engl. \textit{feature selection}). Hier wird jedoch im Gegensatz zur Merkmalsextraktion keine
Transformation der Merkmale durchgeführt, sondern nur eine Teilmenge der verfügbaren Merkmale
gewählt. Daher ist die Merkmalsextrahierung auch näher an der Dimensionsreduktion als die
Merkmalsauswahl.

Man erhofft sich, dass der Klassifikator (oder Regressor) durch die Merkmalsextrahierung robuster
