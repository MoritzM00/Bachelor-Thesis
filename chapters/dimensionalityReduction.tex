...
die \newterm{intrinsische Dimension} der Daten.
...
der intrinsischen Dimension behandelt. In \secref{ch:Dimensionsreduktion:Merkmalsextrahierung} wird
kurz die Relation zum Gebiet der Merksmalsextrahierung und in
\secref{ch:Dimensionsreduktion:Ansaetze} die verschiedenen Ansätze zur Dimensionsreduktion
besprochen.
