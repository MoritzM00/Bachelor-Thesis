...
Eine simple Unterteilung ist die in lineare und nichtlineare Methoden. Während lineare Methoden wie
die Hauptkomponentenanalyse (\secref{ch:MethodenDerDimRed:statistisch:PCA}) nur lineare
...
(\secref{ch:MethodenDerDimRed:statistisch:LLE}), die Self-Organizing Map \parencite{Kohonen.1990}, Uniform Manifold Approximation and Projection (UMAP)% \parencite{McInnes.2018}  
