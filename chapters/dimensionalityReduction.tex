...
bezeichnet $D$ die \newterm{extrinsische Dimension} des zugehörigen Ursprungsraumes $\mathcal{X}$
...
ist. Für eine mathematisch korrekte Definition einer Mannigfaltigkeit wird auf ...\addref
verwiesen.

Wir beziehen uns auf die ursprüngliche (hochdimensionale) Repräsentation durch den
