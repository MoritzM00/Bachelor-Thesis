...
\begin{table}[ht]
	...
	\begin{tabulary}{\linewidth}{CC}
		...
		Kernel PCA                         & $\kappa(\vect{x}_1, \vect{x}_2) = \exp(- \norm{\vect{x}_1 - \vect{x}_2}^2/(2\sigma))$, $\sigma=\sfrac{1}{D}$ \\ \midrule
