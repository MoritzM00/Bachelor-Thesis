...
ist definiert als die Menge der Indizes\unsure{Nachbarschaft als Menge der Indizes oder Vektoren
...
Bis jetzt wurde immer angenommen, dass die intrinsische Dimension $d$ von außen gegeben ist, da die
...
Dimensionsreduktion. Erschwert wird dieses Problem durch die Tatsache, dass es sehr viele
Definitionen der intrinsischen Dimension gibt. Dazu gehören unter anderem die Definition von
\addref (Bennet.1969), die topologische Dimension der Mannigfaltigkeit (siehe
\secref{ch:Dimensionsreduktion:MannigfaltigkeitenIntrinsDim}) und auf der fraktale Dimension
basierende Definitionen wie die Korrelationsdimension (camastra.2002)\addref. Die topologische
Dimension hat sich jedoch, trotz praktischer Schwierigkeiten beim Schätzen, in der Literatur der
Strukturerkennung durchgesetzt \parencite[1]{Campadelli.2015}. Trotzdem gibt es aufgrund des Fehlens einer eindeutigen Definition der
intrinsischen Dimension sehr viele unterschiedliche Schätzer, weswegen eine umfangreiche Behandlung
dessen über den Rahmen dieser Arbeit hinausgeht. Daher wird für einen detaillierten systematischen
Überblick und Vergleich dieser Schätzer auf \textcites{Campadelli.2015}{Bac.2021} verwiesen. In
dieser Arbeit wird der \newterm{Maximum Likelihood Schätzer} von \textcite{Levina.2004} verwendet,
der beispielsweise auch im Vergleich von \textcite{vanderMaaten.2009} eingesetzt wird. Dieser
basiert auf der Idee, dass \ldots
