...
Es sowohl künstliche als auch natürliche Datensätze eingesetzt, um Eigenschaften der verschiedenen Methoden miteinander zu vergleichen. Zu den künstlichen Datensätzen gehört die weit verbreitete \textit{Swiss Roll} und \dots.
Bei den natürlichen Datensätzen wurde einerseits Bilddatensätze, aber auch Textdatensätze ausgewählt, da diese eine sehr hohe extrinsische Dimension aufweisen und daher für die Dimensionsreduktion sehr gut geeignet sind. Daher wurde der MNIST Datensatz \addref sowie \dots ausgewählt.
\section{Resultate}
\label{ch:Vergleich:sec:Resultate}

\begin{figure}[ht]
	\label{fig:SwissRoll-Metrics}
	\begin{center}
