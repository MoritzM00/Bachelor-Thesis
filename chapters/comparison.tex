...
$T(K) = 1­$ entspricht einer perfekten Vertrauenswürdigkeit.
...
Datensätzen auf $\epsilon = 1\mathrm{e}{-3}$ gesetzt.
...
eine Nachbarschaftsgröße von $1 \leq \Kqk \leq 100$ evaluiert. Einige der Abbildungen für die
...
restlichen Methoden. Der Parameter $\Klle$ für Locally Linear Embedding wurde jedoch auf kleinere Werte zwischen fünf und 15 gesetzt, weswegen diese Beobachtung logisch erscheint. Die Hauptkomponentenanalyse kann auf fast allen natürlichen Datensätzen eine gute oder sogar die
