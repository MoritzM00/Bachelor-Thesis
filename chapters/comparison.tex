...
Die eben beschriebenen Punkte (1) und (2) werden \rewrite{umschreiben oder Kovarianzmatrix
	verwenden um auch punkt 2 zu zeigen}im Folgenden zur Verdeutlichung der Zusammenhänge visualisiert.
Dazu wird zuerst die Korrelation der transformierten Daten und anschließend werden die gefundenen
Gewichte der Methoden genauer analysiert. Punkt 1 aus dem theoretischen Zusammenhang wird in
