...
% 	\end{center}	
% 	\caption[Künstliche Datensätze]{\figleft Swiss Roll \figright Twin Peaks}
% \end{figure}
...
verbreitete \textit{Swiss Roll} und der \textit{Twin Peaks} Datensatz, die in dargestellt sind.
...
Daher wurde der MNIST Datensatz \addref sowie \dots ausgewählt.%\figref{fig:ArtificialDatasets}

\idea{Übersicht über alle Datensätze in einer Tabelle mit n_samples und intrinsischer Dimension?}
\section{Resultate}
...
klassische Autoencoder in Hinsicht auf Vertrauenswürdigkeit und LCMC am besten ab, wobei Kernel PCA
und die traditionelle Hauptkomponentenanalyse eine sehr ähnliche Performance zeigen. Locally Linear
Embedding schneidet auf allen drei Kriterien am schlechtesten ab, wobei die Einbettung in zwei
Dimensionen bei Betrachtung größerer Nachbarschaften deutlich schlechter wird. Dies macht in
Anbetracht der lokalen Eigenschaft von LLE Sinn.
