...
hinzufügt werden, der die Größe der Gewichte bestraft. Die häufigste Form dieses sogenannten
textit{weight decay} ist die Summe der Frobeniusnorm der Gewichtsmatrizen.

\subsubsection{Visualisierung der Zusammenhänge}

Die eben beschriebenen Punkte (1) und (2) werden im folgenden zur Verdeutlichung der
Zusammenhängevisualisiert. Dazu wird zuerst die Korrelation der transformierten Daten und
anschließend werden die gefundenen Gewichte der Methoden genauer analysiert. Punkt 1 aus dem
theoretischen Zusammenhang wird in \figref{fig:Korrelationsmatrizen} deutlich.
\begin{figure}[ht]
	\centering
