...
Bei der Hinzunahme von Nichtlinearität zum dreischichtigen Autoencoder, gehen die beschriebenen
Zusammenhänge verloren. Dazu wurden drei dreischichtige Autoencoder mit unterschiedlichen
Aktivierungsfunktionen auf dem MNIST-Datensatz trainiert:
\begin{enumerate}
	\item ein linearer Autoencoder
	\item ein Autoencoder mit Sigmoid-Aktivierungsfunktion im Encoder und einem linearem Decoder
	\item ein nichtlinearer Autoencoder, d.h. sowohl Encoder als auch Decoder verwenden eine
	      Sigmoid-Aktivierungsfunktion
\end{enumerate}
Damit die latenten Repräsentationen visualisiert werden können, wurde intrinsische Dimension auf zwei gesetzt.

\begin{figure}
	\centering
	\includegraphics{autoencoders-nonlinearity.pdf}
	\caption[Latente Repräsentationen von PCA und drei Autoencoder mit unterschiedlichen Aktivierungsfunktionen]{Zweidimensionale latente Repräsentationen von PCA und drei Autoencodern mit unterschiedlichen Aktivierungsfunktionen auf dem MNIST-Datensatz. }
\end{figure}