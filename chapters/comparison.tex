...
\idea{
	...
	\begin{enumerate}
		\item Generalisierungsfehler eines 1-NN Klassifizieres wie Maaten.2009
		\item Trustworthiness und Continuity
		\item Co-Ranking Matrix + viele darauf basierende Maße (Lee.2009)
...
\idea{sehr mathematisch im Detail, Maaten.2009 benutzt den MLE-Schätzer (Levina 2004). Dazu tendiere ich momentan auch}
