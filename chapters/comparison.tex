...
\textcite{Bennett.1969}, die topologische Dimension der Mannigfaltigkeit (siehe
\secref{ch:Dimensionsreduktion:MannigfaltigkeitenIntrinsDim}) und auf der fraktale Dimension
basierende Definitionen wie die Korrelationsdimension \parencite{Camastra.2002}. Aufgrund des Fehlens einer eindeutigen Definition der intrinsischen
Dimension gibt es sehr viele unterschiedliche Schätzer, weswegen eine umfangreiche Behandlung
dessen über den Rahmen dieser Arbeit hinausgeht. Daher wird für einen detaillierten systematischen
Überblick und Vergleich dieser Schätzer auf \textcites{Campadelli.2015}{Bac.2021}{Verveer.1995}
verwiesen.

Im Rahmen dieser Arbeit wird der \newterm{Maximum Likelihood Schätzer} von \textcite{Levina.2004}
verwendet, der beispielsweise auch im Vergleich von \textcite{vanderMaaten.2009} eingesetzt wird.
Dieser basiert auf der Idee, dass \ldots
