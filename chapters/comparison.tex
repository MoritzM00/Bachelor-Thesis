...
\textit{fraktalen Dimension} wie zum Beispiel der Schätzer der Korrelationsdimension \parencite{Camastra.2002} oder auf Charakteristika von Nachbarschaften \parencite[1]{Campadelli.2015} basieren. Zu letzterem gehört auch der viel zitierte und in dieser
Arbeit verwendete \newterm{Maximum Likelihood Schätzer} von \textcite{Levina.2004}. Dieser basiert
auf der Idee, dass \ldots
