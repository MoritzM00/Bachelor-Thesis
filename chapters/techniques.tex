...
\newterm{Sparse Autoencoder} oder der für das Lernen von Mannigfaltigkeiten besonders interessante
\newterm{Contractive Autoencoder}, der im Abschnitt \subsecref{ch:MethodenDerDimRed:modern:CAE}
genauer behandelt wird.

\subsubsection{Verhältnis zur Hauptkomponentenanalyse}

\subsection{Contractive Autoencoder}
\label{ch:MethodenDerDimRed:modern:CAE}
