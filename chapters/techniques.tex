...
Die Idee ist
es, die \textit{Sensitivität} des Autoencoders für den Input zu bestrafen.
...
\end{equation}
was der Summe über die quadrierten Einträge der Jacobi-Matrix entspricht. Intuitiv gesehen werden so lokale Nachbarschaften auf \textit{kleinere} Nachbarschaften in der niedrigdimensionalen Repräsentation abgebildet, das heißt der Autoencoder wirkt kontrahierend. Motiviert wird dies durch die lokal relevanten Richtungen auf einer Mannigfaltigkeit. Die Richtungen, die orthogonal zur Mannigfaltigkeit sind, sollten weniger Einfluss auf die Rekonstruktion haben. Durch die Bestrafung der Sensitivität muss der Autoencoder theoretisch mehr Fokus auf die lokal relevanten Richtungen, d.h. die Richtungen mit viel Variation entlang der Mannigfaltigkeit legen \parencite[1]{Rifai.2011}.
