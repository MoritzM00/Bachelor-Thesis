...
Darüber hinaus ist es möglich die Kernel-Matrix mitzulernen, wie es bspw. in \textit{Semidefinite
	Embedding} \parencite{Weinberger.2004b} der Fall ist. Damit entfällt die Wahl eines passendes Kernels und seiner
...
lernen und damit die Flexibilität der Architektur auszunutzen \parencite[4]{Charte.2018}. Die Aktivierungsfunktion wird später bei der Wahl der Architektur eines
Autoencoders noch genauer erläutert.
...
der Zielfunktion zu umgehen \parencite[509]{Goodfellow.2016}.\unsure{Wieso ist der CAE gut für das Lernen von Mannigfaltigkeiten?}