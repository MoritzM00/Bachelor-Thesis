...
\end{equation}
berechnet werden.\rewrite{Umschreiben und auf Richtigkeit überprüfen}
...
Erstens muss zwischen vollvernetzten und \textit{Convolutional} Schichten werden. Letztere können
eingesetzt werden, wenn der Input des Autoencoders ein Bild ist. Der Autoencoder wird dann als
Convolutional Autoencoder (ConvAE) bezeichnet. Der Grund dafür ist der Aufbau dieser
Schichten.\rewrite{Conv layers erklären} In allen anderen Fällen werden meist vollvernetzte
Schichten eingesetzt, d.h. jedes Neuron hat eine Verbindung zu jedem Neuron aus der Folgeschicht.
...
1000 und wählt man $m=3$ und hat die Bottleneck-Schicht 10 Neuronen, dann hat dieser simple
Autoencoder bereits 20 000 trainierbare Gewichte.\footnote{Genau genommen hat der Encoder $1000
		\cdot 10 = 10000$ Gewichte und 10 Biases. Der Decoder hat 10000 Gewichte und 1000 Biases. Der
...
der Neuronen in der ersten und letzten Schicht entspricht immer der Größe des Inputvektors, d.h.
der extrinsischen Dimension $D$.
