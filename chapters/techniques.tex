...
Algorithmen in dieser Arbeit in \textit{statistische} und \textit{Machine Learning} Methoden
...
haben das Ziel von Trainingsdaten auf neue, das heißt ungesehene (Test-)Daten zu generalisieren und
besitzen nicht immer theoretische Optimalitätsgarantien. Neuronale Netze sind hierfür ein
Paradebeispiel und werden deshalb in \secref{ch:MethodenDerDimRed:modern} eingehend behandelt.
