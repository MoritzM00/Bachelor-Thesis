...
Die Performance der Kernel PCA hängt entscheidend von der Wahl des Kernels ab. Leider gibt es keine
...
Regressoren wie z.B. die Support Vector Machine sehr gut, da die Wahl der Qualitätskriterien klar
ist. Für die Dimensionsreduktion ist die Wahl des Qualitätskriteriums nicht so trivial, wie wir
später in \subsecref{ch:Vergleich:sec:Methodik:subsec:Qualitaetskriterien} sehen werden.

In der Praxis sehr häufig anzutreffen sind Gaußsche Kernel (auch: Radiale Basisfunktionen (RBF))
\begin{equation}
