...
\nomenclature[L, 011]{$\vect{a}^{(i)}$}{Der $i$-te Eintrag des Vektors $\vect{a}$}
...
\nomenclature[L, 070]{$\norm{\vect{a}}$}{Die euklidische Norm (auch $L_2$-Norm) eines Vektors $\vect{a}$}
...
\nomenclature[M, 011]{$\lvert \set{A} \rvert$}{Die Kardinalität (auch: Mächtigkeit) einer Menge}
