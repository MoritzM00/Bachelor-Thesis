...
In diesem Kapitel wird kurz auf die in dieser Arbeit benutzte mathematische Notation eingegangen, die sich größtenteils an \textcite{Goodfellow.2016} orientiert.
...
und Matrizen durch fettgedruckte Großbuchstaben wie $\mat{A}$ gekennzeichnet.\nomenclature[A, 03]{$\mat{A}$}{Eine Matrix}
Zufallsvariablen unterscheiden sich von normalen Vektoren und Matrizen durch die kursive Schriftart.\unsure{wie soll ich Zufallsvariablen von nicht-ZV unterscheiden?}
