...
\usepackage[german,colorinlistoftodos,prependcaption,textsize=tiny]{todonotes}
...
\renewcommand{\nomgroup}[1]{%
    ...
    \ifstrequal{#1}{P}{Wahrscheinlichkeitstheorie}{%
...
\numberwithin{equation}{section} % eq. numbering style x.x.x
